...
module.exports = (robot) ->
  ...
  subscribeToList = (msg) ->
    ...
    msg.reply "Subscribing #{email_address} ..."
    ...
    api.subscribers.addSubscriber list_id, {
      ...
      if err
        ...
        msg.send "Subscribed #{email_address}."
  ...
  unsubscribeFromList = (msg) ->
    ...
    email_address = msg.match[2]
    msg.reply "Unsubscribing #{email_address} ..."
    ...
    api.subscribers.deleteSubscriber list_id, email_address, (err, data) ->
      if err
        ...
        msg.send "Unsubscribed #{email_address}."
  ...
  latestCampaign = (msg) ->
    ...
    api.clients.getSentCampaigns client_id, (err, data) ->
      if err
        ...
        msg.send "No campaigns configured for this client."
      else
        ...
        api.campaigns.getSummary cid, (err, data) ->
          if err
            ...
            msg.send "Last campaign \"#{campaign_name}\" was sent to" +
              " #{data['Recipients']} subscribers (#{data['UniqueOpened']}" +
              " opened, #{data['Clicks']} clicked, #{data['Unsubscribed']}" +
              " unsubscribed)"
  ...
  checkCreatesendConfiguration = (msg) ->
    unless api_key && client_id && list_id
      msg.send "You are missing one or all of [CREATESEND_API_KEY," +
        " CREATESEND_CLIENT_ID, CREATESEND_LIST_ID]"
      return false
    true
  ...
  formatErrorMessage = (err) ->
    ...
    if err.Message
      ...
      err = err.toString().substring(0, 1000)
